package {
	...
	public class Main {
		...
		private function onConfigLoaded():void {
			...
			Scene.open("scene/GameScene.scene",true,Handler.create(this,this.onLoadSceneComplete));
		}
		private function onLoadSceneComplete():void{
			//var dashGrid:DashGrid = new DashGrid();
			//Laya.stage.addChild(dashGrid);
		}
	}
}