package script {
	 ...
	 */
	public class MainViewUI extends GameSceneUI {
		
		/**设置单例的引用方式，方便其他类引用 */
		public static var instance:MainViewUI;
		/**当前游戏积分字段 */
		private var _score:Number;
		/**游戏控制脚本引用，避免每次获取组件带来不必要的性能开销 */
		private var _control:GameControl;
		
		public function MainViewUI():void {
			super();
			MainViewUI.instance = this;
			//关闭多点触控，否则就无敌了
		...
		override public function onEnable():void {
			...
			Laya.loader.load("res/atlas/fx/tex.atlas", Handler.create(this, onFxAtlasLoaded));
		}
		private function onFxAtlasLoaded():void{
