	...
	public class ShaderInit3D {
		...
		public static function __init__():void {
			...
			attributeMap = {
				'a_position': VertexMesh.MESH_POSITION0, 
				'a_normal': VertexMesh.MESH_NORMAL0, 
				'tangent': VertexMesh.MESH_TANGENT0, 
				'binormal': VertexMesh.MESH_BINORMAL0, 
				'uv': VertexMesh.MESH_TEXTURECOORDINATE0, 
				'a_BoneWeights': VertexMesh.MESH_BLENDWEIGHT0, 
				'a_BoneIndices': VertexMesh.MESH_BLENDINDICES0, 
				'a_Tangent0': VertexMesh.MESH_TANGENT0};
			uniformMap = {
				...
				'u_shadowMap1': [Scene3D.SHADOWMAPTEXTURE1, Shader3D.PERIOD_SCENE], //TODO:SM
				'u_shadowMap2': [Scene3D.SHADOWMAPTEXTURE2, Shader3D.PERIOD_SCENE], //TODO:SM
				'u_shadowMap3': [Scene3D.SHADOWMAPTEXTURE3, Shader3D.PERIOD_SCENE], //TODO:SM
				'u_shadowPSSMDistance': [Scene3D.SHADOWDISTANCE, Shader3D.PERIOD_SCENE],//TODO:SM
				'u_lightShadowVP': [Scene3D.SHADOWLIGHTVIEWPROJECT, Shader3D.PERIOD_SCENE],//TODO:SM
				'u_shadowPCFoffset': [Scene3D.SHADOWMAPPCFOFFSET, Shader3D.PERIOD_SCENE]};
