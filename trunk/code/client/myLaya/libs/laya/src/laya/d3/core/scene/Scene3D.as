	...
	public class Scene3D extends Sprite implements ISubmit, ICreateResource {
		...
		public function Scene3D() {
			...
			if (Render.isConchApp) {//[NATIVE]
				...
				_conchData._int32Data[SpriteConst.POSCALLBACK_OBJ_ID] = this._callbackFuncObj.id;
				_callbackFuncObj.addCallbackFunc(3, (renderCallbackFromNative as Object).bind(this));
