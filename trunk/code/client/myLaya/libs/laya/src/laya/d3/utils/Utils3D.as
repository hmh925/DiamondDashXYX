package laya.d3.utils {
	...
	public class Utils3D {
		...
		public static function _createSceneByJsonForMaker(nodeData:Object, outBatchSprites:Vector.<RenderableSprite3D>, initTool:* = null):Scene3D {
			...
			_addComponentByJsonForMaker(nodeData, outBatchSprites);
			return scene3d;
		}
		 ...
		 * @private
		 */
		public static function _addComponentByJsonForMaker(nodeData:Object, outBatchSprites:Vector.<RenderableSprite3D>):void {
			...
			if (childData) {
				for (var i:int = 0, n:int = childData.length; i < n; i++) {
					var child:* = _addComponentByJsonForMaker(childData[i], outBatchSprites);
				}
			}
