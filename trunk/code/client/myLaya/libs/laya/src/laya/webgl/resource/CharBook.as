package laya.webgl.resource {
	...
	import laya.utils.PerfHUD;
	import laya.utils.Stat;
	import laya.utils.WordText;
	import laya.webgl.canvas.WebGLContext2D;
	import laya.webgl.text.ArabicReshaper;
	/**
	 * key:font
	 *    下面是各种大小的page
	 * 	   每个大小的page可以有多个
	...
	public class CharBook {
		...
		*/
		...
		protected function _drawCharRenderInfo(ctx:WebGLContext2D, ri:CharRenderInfo,x:int,y:int):void {
			...
			ctx._drawTextureM( ri.tex.texture as Texture, 
				x - _curPage.margin_left, y - _curPage.margin_top, ri.bmpWidth , ri.bmpHeight, 
				null, 1.0, ri.uv);
			if ((ctx as Object).touches) {
				(ctx as Object).touches.push(ri);
			}
