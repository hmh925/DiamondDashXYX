package laya.d3.physics.shape {
	...
	public class CompoundColliderShape extends ColliderShape {
		...
		public function addChildShape(shape:ColliderShape):void {
			...
			if (_attatchedCollisionObject) {
				_attatchedCollisionObject._removeFromSimulation();
				_attatchedCollisionObject._onShapeChange(this);//重新计算中心
				_attatchedCollisionObject._addToSimulation();
			}
		}
